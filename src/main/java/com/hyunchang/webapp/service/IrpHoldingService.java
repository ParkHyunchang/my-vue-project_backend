...
public class IrpHoldingService {
    ...
    public IrpHoldingService(IrpHoldingRepository irpHoldingRepository,
    ...
    public IrpHolding addHolding(String userId, PortfolioAssetType assetType, String market, String name,
        ...
        log.info("[STOCK/IRP] user={}({}), CREATE id={} symbol={} assetType={} market={} quantity={} avgPrice={}",
    ...
    public IrpHolding updateHolding(String userId, Long id, Long quantity, Double avgPrice) {
        IrpHolding holding = irpHoldingRepository.findByIdAndUserUserId(id, userId)
        ...
        log.info("[STOCK/IRP] user={}({}), UPDATE id={} symbol={} quantity={} avgPrice={}",
            userId, SecurityUtils.getCurrentUserRoleName(),
    ...
    public IrpHolding updateCore(String userId, Long id, boolean core) {
        ...
        log.info("[STOCK/IRP] user={}({}), CORE id={} symbol={} core={}",
            userId, SecurityUtils.getCurrentUserRoleName(),
    ...
    public void deleteHolding(String userId, Long id) {
        ...
        log.info("[STOCK/IRP] user={}({}), DELETE id={} symbol={} quantity={} avgPrice={}",
            userId, SecurityUtils.getCurrentUserRoleName(),
