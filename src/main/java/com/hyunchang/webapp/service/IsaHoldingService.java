...
public class IsaHoldingService {
    ...
    public IsaHoldingService(
            IsaHoldingRepository isaHoldingRepository, UserRepository userRepository) {
    ...
    public IsaHolding addHolding(
        ...
        log.info(
                "[STOCK/ISA] user={}({}), CREATE id={} symbol={} assetType={} market={} quantity={} avgPrice={}",
                userId,
    ...
    public IsaHolding updateHolding(String userId, Long id, Long quantity, Double avgPrice) {
        ...
        log.info(
                "[STOCK/ISA] user={}({}), UPDATE id={} symbol={} quantity={} avgPrice={}",
                userId,
                SecurityUtils.getCurrentUserRoleName(),
                saved.getId(),
                saved.getSymbol(),
    ...
    public IsaHolding updateCore(String userId, Long id, boolean core) {
        ...
        log.info(
                "[STOCK/ISA] user={}({}), CORE id={} symbol={} core={}",
                userId,
                SecurityUtils.getCurrentUserRoleName(),
                saved.getId(),
                saved.getSymbol(),
    ...
    public void deleteHolding(String userId, Long id) {
        ...
        log.info(
                "[STOCK/ISA] user={}({}), DELETE id={} symbol={} quantity={} avgPrice={}",
                userId,
                SecurityUtils.getCurrentUserRoleName(),
                holding.getId(),
                holding.getSymbol(),
