...
public final class AiPromptCatalog {
    ...
    private static PromptDefinition portfolioAnalysis() {
        return new PromptDefinition(
            ...
            recommendations: 2개 또는 3개. ★★ 반드시 아래 '최근 시장 뉴스 헤드라인' 에서 출발해서 추천할 것.
              - 각 추천 종목은 아래 헤드라인 중 하나에서 직접 언급되었거나 명백히 수혜/연관되는 실재 상장 종목이어야 함.
                (예: "엔비디아 실적 호조" 헤드라인 → 엔비디아 또는 명확한 공급망 수혜주)
              - newsBasis 필드에 그 추천의 근거가 된 헤드라인을 아래 목록에서 그대로 1건 복사해 넣을 것 (꾸며내지 말 것).
