    ...
    private static PromptDefinition portfolioIsaAnalysis() {
        return new PromptDefinition(
            ...
            - 추천은 ISA 계좌에 새로 담기 적합한 중장기 후보 또는 기존 보유자산의 비중 조정 관점으로만 제시하세요.
              ...
              신규 편입 후보는 제공된 최근 시장 뉴스 또는 보유 포트폴리오의 부족한 자산군/섹터를 근거로 하세요.
              손절/축소 검토 후보는 손실률, 단기 급락, 계좌 목적과 맞지 않는 집중, 부정적 뉴스가 있을 때만 제시하세요.
              근거가 부족하면 후보를 억지로 만들지 말고 '해당 없음'이라고 쓰세요.
            - 보유 자산별 판단은 각 자산마다 반드시 “보유”, “추가매수”, “관망” 중 하나로 제시하세요.
              판단이 비어 있거나 전부 관망으로 끝나지 않도록, 현재 비중·손익률·뉴스·현금성 자산 역할 중 최소 하나를 근거로 설명하세요.
    ...
    private static PromptDefinition portfolioIrpAnalysis() {
        return new PromptDefinition(
            ...
            - 추천은 IRP 계좌에 적합한 장기·분산·방어적 후보 또는 기존 보유자산의 비중 조정 관점으로만 제시하세요.
              ...
              신규 편입 후보는 제공된 최근 시장 뉴스 또는 보유 포트폴리오의 부족한 자산군/섹터를 근거로 하세요.
              손절/축소 검토 후보는 손실률, 단기 급락, 노후자산 관점의 과도한 변동성, 부정적 뉴스가 있을 때만 제시하세요.
              근거가 부족하면 후보를 억지로 만들지 말고 '해당 없음'이라고 쓰세요.
            - 보유 자산별 판단은 각 자산마다 반드시 “보유”, “추가매수”, “관망” 중 하나로 제시하세요.
