...
public class IsaHoldingController {
    ...
    public ResponseEntity<?> updateHolding(
        ...
        IsaHolding updated =
                isaHoldingService.updateHolding(
    ...
    public ResponseEntity<?> updateCore(
        ...
        IsaHolding updated =
                isaHoldingService.updateCore(SecurityUtils.getCurrentUserId(), id, core);
        return ResponseEntity.ok(updated);
    }
