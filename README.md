...
ANTHROPIC_API_KEY=
# AI 종목 분석 provider 체인 (GEMINI 필수, 나머지는 선택)
GEMINI_API_KEY=
GROQ_API_KEY=
...
# 미국주식 실계좌 소액 자동매매 (매수는 D+0 USD 외화예수금만 사용)
KIWOOM_US_TRADE_ENABLED=true
KIWOOM_US_STRATEGY_ENABLED=true
KIWOOM_US_MAX_ORDER_PERCENT=10
KIWOOM_US_MAX_ALLOCATION_PERCENT=20
KIWOOM_US_MAX_POSITIONS=1
KIWOOM_US_DAILY_MAX_BUYS=1
KIWOOM_US_DAILY_LOSS_LIMIT_PERCENT=2
```
